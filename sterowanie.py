...
class Train:
    ...
    def __init__(self):
        ...
        self.data = pd.read_csv('./txt_files/trainingSet.csv', sep=',', header=None)
        self.header_list = ['waitings_client', 'orders_to_kitchen', 'dishes_waiting_for_delivery', 'actual_collecing1','actual_collecing2', 'actual_collecing3', 'result_state']
...
#train = Train()
#train.build_tree(train.header_list, train.data)
#train.get_tree_dot()
#train.get_model()
#train.get_tree_png()
#x_test = train.data.values[1:99, 0:6]
